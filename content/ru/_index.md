---
title: "Вас приветствует компания ООО «МонолитКомфорт Энерго»"
description: "Домашняя страница и приветствие от компании ООО «МонолитКомфорт Энерго»"
slug: home
summary: "Рады, очень рады!"
...
UseHugoToc: true
cover:
  image: "img/shina-mednaya-stimpank-temnaya.png" # путь к обложке поста
  alt: "шина медная стимпанк темная" # alt text
  caption: "шина медная стимпанк темная" # display caption under cover
...
<div class="theme-logo">
  <img src="/mke-logo-brw-o.svg" alt="Логотип">
</div>
